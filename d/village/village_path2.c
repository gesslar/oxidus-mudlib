...
void setup() {
  ...
  set_long(
  "Westward from the village square, the path transitions from cobblestone "
  "to packed earth, guiding travelers towards the quieter side of the "
  "village. Here, nestled among the modest dwellings, a small, unassuming "
  "tavern quietly asserts its presence. Its wooden facade, weathered by "
  "time, and a dimly lit lantern by the door, offer a welcoming if "
  "understated, invitation. The sign, swaying gently, depicts a frothy "
  "mug, symbolizing the simple comforts waiting within. This stretch of the "
  "path, less traveled yet worn smooth by the tavern's regulars, leads to "
  "a place of rest and camaraderie, where tales and ale are shared with "
  "equal generosity.");
...
set_exits(([
  ...
  set_items(([
    ...
    "tavern" :
      ...
      "facade, a testament to many a story shared and heard, invites "
      "all to enter and leave the world behind.",
    ({ "wooden facade", "facade" }) :
      "Bearing the marks of time, the facade stands as a humble "
      "guardian of the tavern's threshold. It speaks of endurance, "
      "of countless greetings and farewells, and of the simple, "
      "unspoken promise of shelter to those who seek it.",
    ({ "dimly lit lantern", "lantern" }) :
      "Hanging by the door, the lantern casts a soft glow, piercing the "
      "twilight to guide the wayfarer. It's a beacon of the familiar "
      "and the cozy, an understated herald of the refuge that lies "
