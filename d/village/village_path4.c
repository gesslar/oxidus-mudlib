...
void setup() {
  ...
  set_items(([
    ({ "village square", "square" }) :
      ...
      "square's communal harmony fades into the background as one "
      "ventures south. It's a place of simple joys and unity, "
      "contrasting sharply with the luxury that lies ahead.",
    ({ "brick path", "path" }) :
      "This path, with its bricks laid with precision, serves as a "
      "grand avenue towards opulence. Each brick, a testament to "
      "meticulous design, guides the way to a display of wealth that "
      "knows no bounds, setting the stage for the grandeur to come.",
    ({ "pruned hedges", "hedges" }) :
      "The hedges along this path are not merely trimmed but sculpted, "
      "each one an exercise in extravagance. Their elaborate shapes "
      "speak of a desire to impress and dominate, framing the route "
      "with a greenery that's as controlled as it is lavish.",
    ({ "statues" }) :
      ...
      "ostentation. They stand as silent sentinels to extravagance, "
      "each one a declaration of wealth that verges on the excessive.",
    ({ "ostentatious manor", "manor" }) :
      "Dominating the end of the path, the manor looms large, a "
      "spectacle of architectural excess. Its spires reach skyward, "
      "while gold leaf and flamboyant banners vie for attention, "
      "embodying a wealth so immense it borders on the surreal.",
    ...
    ({ "flamboyant banners", "banners" }) :
      "Fluttering from the rooftop, these banners are as bold in colour "
