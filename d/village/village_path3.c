...
void setup() {
  ...
  set_long(
  "Eastward from the lively centre of the village square, the path becomes "
  "more refined, with well-placed stones and borders of flowering shrubs "
  "indicating a transition to a more affluent section of the village. Here, "
  "among well-tended gardens and impressive facades, stands a discreet yet "
  "elegant building known to house the village financier. A polished brass "
  "plaque beside the door gleams in the sunlight, marking the entrance with "
  "a level of sophistication that speaks to the serious nature of the "
  ...
  set_items(([
    ({ "village square", "square" }) :
      ...
      "the communal vibrancy for a realm of quiet prosperity. It's a "
      "place where the village's pulse can be felt, now giving way to "
      "the serene elegance of the affluent section.",
    ({ "refined path", "path" }) :
    ...
    ({ "impressive facades", "facades" }) :
      "The facades here are not just structures; they are statements "
      "of status and achievement. With their grand designs and "
      "impeccable maintenance, they stand as silent yet eloquent "
      "testimonies to the village's wealthier denizens.",
    ...
    ({ "polished brass plaque", "brass plaque", "polished plaque",
       "plaque" }) :
      "Nestled beside the door, the plaque is not just an identifier "
